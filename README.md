...
Use the graph canvas to build or adjust a small computation graph, edit input and parameter values in the nodes, then step through the forward pass, loss, backward pass, and update controls to see how gradients drive learning. Use save and import to continue a workspace later.
